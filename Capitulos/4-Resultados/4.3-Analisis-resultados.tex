...
En esta sección presentamos y discutimos los resultados, comparando el modelo SNN base (A--B), la SNN híbrida (A--B--C) y modelos TSFEDL \cite{AGUILERAMARTOS2023223}. Incluimos análisis por dataset, ablasiones y eficiencia. Los tiempos de entrenamiento reportados deben interpretarse considerando que todos los modelos se ejecutaron en CPU (véase la Sección~\ref{subsec:entorno}).
...
Comparamos con los siguientes modelos de la librería TSFEDL \cite{AGUILERAMARTOS2023223} basándonos en los resultados de los experimentos de evaluación:
\begin{itemize}
