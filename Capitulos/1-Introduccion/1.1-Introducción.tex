...
\begin{itemize}
    \item\textbf{\hyperref[chap:introduccion]{Capítulo 1}}: Este primer capítulo presenta la motivación del proyecto, explicando por qué es tan importante detectar anomalías en series temporales para distintos sectores industriales. Se establecen los objetivos específicos: diseñar arquitecturas SNNs optimizadas e implementar modelos sostenibles que reduzcan el consumo energético. También se incluye la planificación temporal del proyecto con estimaciones de costes y duración de las tareas principales.
    
    \item\textbf{\hyperref[chap:fundamentos]{Capítulo 2}}: Este capítulo presenta un análisis de la evolución histórica de los métodos de detección de anomalías, desde técnicas estadísticas clásicas hasta los enfoques más recientes de aprendizaje profundo. Se examinan los fundamentos estadísticos y enfoques tradicionales, las aplicaciones del aprendizaje profundo en detección de anomalías, y la optimización de hiperparámetros mediante técnicas bayesianas. Se dedica especial atención a las SNNs, la arquitectura del modelo base en que hace de punto de partida para este trabajo, y la comparación de eficiencia energética entre diferentes paradigmas computacionales.
    
    \item\textbf{\hyperref[chap:especificacion]{Capítulo 3}}: En este capítulo se define el alcance específico del proyecto, las hipótesis de partida y las restricciones identificadas. Se describe en detalle la solución propuesta, incluyendo la justificación para usar BindsNET como framework de desarrollo y los desafíos técnicos encontrados durante la configuración del entorno. El capítulo profundiza en la arquitectura del nuevo modelo híbrido SNN-CNN, explicando las innovaciones introducidas respecto a la implementación original, incluyendo la capa convolucional parametrizable y los modos de procesamiento. También describe los algoritmos de preprocesamiento desarrollados para los datasets IOPS y CalIt2, incluyendo normalización temporal, completado de datos y técnicas de expansión de etiquetas.
    
    \item\textbf{\hyperref[chap:resultados]{Capítulo 4}}: Este capítulo presenta la evaluación experimental del modelo propuesto. Se describen los escenarios experimentales implementados, incluyendo la configuración de hardware y software, los datasets utilizados y las estrategias de particionado temporal. Se detalla la metodología de evaluación, con especial énfasis en las métricas de calidad (precisión, recall, F1-score) y MSE. El análisis de resultados incluye comparaciones detalladas entre el modelo SNN base, el modelo híbrido propuesto y baselines de la librería TSFEDL \cite{AGUILERAMARTOS2023223}, así como evaluaciones de escalabilidad con diferentes configuraciones de neuronas (100, 200, 400).
    
    \item\textbf{\hyperref[chap:conclusiones]{Capítulo 5}}: El último capítulo sintetiza los principales hallazgos del trabajo, evaluando el grado de cumplimiento de los objetivos planteados y el impacto de las contribuciones realizadas. Se presenta una discusión de resultados con interpretación técnica e implicaciones prácticas, se discuten las limitaciones identificadas durante el desarrollo y se proponen direcciones para trabajos futuros que puedan extender y mejorar los métodos desarrollados, con especial atención a la evaluación energética en hardware neuromórfico.
\end{itemize}
