...
\begin{itemize}
    ...
    \item \textbf{Objetivo cumplido parcialmente}: O3 (Implementación sostenible) - Se desarrolló el análisis teórico de eficiencia mediante estimación de MACs asumiendo dispersidad, pero no se pudo validar en hardware neuromórfico por limitaciones de acceso.
\end{itemize}
...
\begin{enumerate}
    ...
    \item Análisis preliminar de complejidad computacional (estimación de MACs asumiendo dispersidad), sentando bases para evaluación energética futura en hardware neuromórfico.
...
El modelo híbrido es aplicable a escenarios de edge computing al reducir cómputo mediante dispersidad, siempre que se complemente con:
\begin{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Robustez frente a deriva}: Evaluar la degradación de rendimiento bajo deriva del concepto e inyección de ruido, implementando técnicas de aprendizaje continuo específicas para SNNs.
\end{itemize}
