...
\begin{enumerate}
    ...
    \item Pipeline de preprocesamiento reproducible: cuantización dinámica por cuantiles expandidos, expansión de etiquetas para mejorar la cobertura de eventos anómalos, y segmentación temporal en ventanas de longitud.
...
\begin{itemize}
    ...
    \item \textbf{Pipeline neuromórfico}: Versionado de topologías de red y pesos sinápticos con herramientas específicas para arquitecturas basadas en impulsos.
\end{itemize}
