...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=1.0\textwidth]{Imagenes/Diagrama.png}
    \caption{Ejemplo ilustrativo. Evolución del voltaje de membrana en una neurona LIF. Fuente: Elaboración propia.}
