...
\begin{itemize}
    ...
    \item Optimización automatizada con Optuna: Los hiperparámetros ($\nu1$, $\nu2$, umbral, decaimiento, parámetros de kernel) se optimizan automáticamente para maximizar métricas como F1-score, eliminando la necesidad de ajuste manual.
...
En términos de implementación, las diferencias clave incluyen la adición de monitores específicos para la capa C, tres modos de procesamiento convolucional (direct, weighted\_sum, max) que serán explicados en la Sección 3.3.5, y evaluación dual de métricas tanto para la capa B como para la capa C. Esta arquitectura híbrida resulta en un modelo más flexible, manteniendo la eficiencia computacional inherente a las SNNs mientras incorpora las capacidades de extracción de características de las redes convolucionales.
