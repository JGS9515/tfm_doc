...
En términos de implementación, las diferencias clave incluyen la adición de monitores específicos para la capa C, tres modos de procesamiento convolucional (direct, weighted\_sum, max) que serán explicados en la Sección 3.5.5, y evaluación dual de métricas tanto para la capa B como para la capa C. Esta arquitectura híbrida resulta en un modelo más flexible, manteniendo la eficiencia computacional inherente a las SNNs mientras incorpora las capacidades de extracción de características de las redes convolucionales.
